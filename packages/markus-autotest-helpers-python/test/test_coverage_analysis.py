import os
from markus_autotest_helpers_python.coverage_analysis import get_test_coverage_dict, make_test_coverage_fixture

import fixtures.example_tests as example_tests

coverage_fixture = make_test_coverage_fixture(example_tests, [os.path.join(os.path.dirname(__file__), 'fixtures', 'buggy_function.py')])
